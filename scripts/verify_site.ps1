...
try {
  ...
  $Paths = @('/','/index.html','/work.html','/about.html','/styles.css','/scripts/site.js','/scripts/home-signal-field.mjs','/scripts/home-signal-control-panel.mjs','/projects/ai-ml-timeline.html','/projects/ml-vs-deep-learning.html','/projects/generative-prompt-sensei.html','/projects/product-team-bias.html','/assets/fonts/Archivo-VariableFont_wdth,wght.woff2','/assets/images/timeline-work-wide.webp','/assets/images/timeline-poster.webp','/ai-ml-timeline.png')
